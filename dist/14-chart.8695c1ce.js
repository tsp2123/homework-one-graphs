...
(function () {
  ...
  var svg = d3.select('#chart14').append('svg').attr('width', width + margin.left + margin.right).attr('height', height + margin.top + margin.bottom).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');

  // Build your scales here
  var heightScale = d3.scaleLinear().domain([0, 10]).range([0, height]);
  ...
  function ready(datapoints) {
    ...
    svg.selectAll('rect').data(datapoints).enter().append('rect').attr('y', function (d) {
      return height - heightScale(d.hamburgers);
    }).attr('x', function (d) {
      return xPositionScale(d.name);
    }).attr('width', xPositionScale.bandwidth()).attr('height', function (d) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","14-chart.js"], null)
//# sourceMappingURL=/14-chart.8695c1ce.map