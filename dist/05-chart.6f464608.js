...
(function () {
  ...
  var svg = d3.select('#chart5').select('svg').attr('height', height).attr('width', width);
  ...
  svg.selectAll('circle').data(datapoints).enter().append('circle').attr('fill', function (d) {
    return colorScale(d.animal);
  }).attr('cy', 100).attr('cx', function (d) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","05-chart.js"], null)
//# sourceMappingURL=/05-chart.6f464608.map