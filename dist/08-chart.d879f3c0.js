...
(function () {
  ...
  var svg = d3.select("#chart8").select("svg").attr("height", height + 50).attr("width", width).select("g").attr("transform", "translate(50, 0)");

  var data = [{ 'name': 'Panda', 'weight': 150 }, { 'name': 'Cat', 'weight': 8 }, { 'name': 'Horse', 'weight': 840 }, { 'name': 'Pig', 'weight': 100 }];
  ...
  svg.selectAll('circle').data(data).attr('cy', height).attr('cx', function (d) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","08-chart.js"], null)
//# sourceMappingURL=/08-chart.d879f3c0.map