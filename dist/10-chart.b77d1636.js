...
module.exports = "/eating-data.e059d923.csv";
...
(function () {
  ...
  var svg = d3.select('#chart10').append('svg').attr('width', width + margin.left + margin.right).attr('height', height + margin.top + margin.bottom).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');

  // Build your scales here
  var xPositionScale = d3.scaleLinear().domain([0, 10]).range([0, 350]);

  var yPositionScale = d3.scaleLinear().domain([0, 10]).range([350, 0]);
  ...
  function ready(datapoints) {
    ...
    svg.selectAll('circle').data(datapoints).enter().append('circle').attr('r', 6).attr('fill', colorScale).attr('cx', function (d) {
  ...
  svg.append('g').attr('class', 'axis x-axis').attr('transform', 'translate(0,' + 350 + ')').call(xAxis);
})();
},{"d3":"node_modules/d3/index.js","./eating-data.csv":"eating-data.csv"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","10-chart.js"], null)
//# sourceMappingURL=/10-chart.b77d1636.map