...
(function () {
  ...
  d3.csv(require('./fake-data.csv')).then(ready).catch(function (err) {
  ...
  var svg = d3.select('#chart9').append('svg').attr('width', width).attr('height', height).style('background', 'red');
...
},{"d3":"node_modules/d3/index.js","./fake-data.csv":"fake-data.csv"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","09-chart.js"], null)
//# sourceMappingURL=/09-chart.c1e796b8.map