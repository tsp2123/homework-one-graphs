...
},{}],"12-chart.js":[function(require,module,exports) {
'use strict';
...
(function () {
  ...
  var svg = d3.select('#chart12').append('svg').attr('width', width + margin.left + margin.right).attr('height', height + margin.top + margin.bottom).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
  ...
  var colorScale = d3.scaleOrdinal().domain(['dog', 'cat', 'cow']).range(['#7fcdbb', '#fdbb84', '#2c7fb8']);
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","12-chart.js"], null)
//# sourceMappingURL=/12-chart.10c67945.map