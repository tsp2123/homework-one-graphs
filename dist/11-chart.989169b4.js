...
},{}],"11-chart.js":[function(require,module,exports) {
'use strict';
...
(function () {
  ...
  var width = 400;
  var height = 400;
  var svg = d3.select('#chart11').append('svg').attr('width', width + margin.left + margin.right).attr('height', height + margin.top + margin.bottom).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');

  // using all of that cut-and-paste magic

  // Build your scales here

  var pointScale = d3.scalePoint().domain(['cat', 'cow', 'dog']).range([0, 400]).padding(0.25);
  ...
  function ready(datapoints) {
    ...
    svg.selectAll('circle').data(datapoints).enter().append('circle').attr('r', 6).attr('cy', function (d) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","11-chart.js"], null)
//# sourceMappingURL=/11-chart.989169b4.map