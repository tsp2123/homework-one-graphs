...
(function () {
  ...
  var widthScale = d3.scaleLinear().domain([0, 100]).range([0, 400]);

  // Get the svg with the id of 'chart2'
  var svg = d3.select('#chart2').attr('height', 200).attr('width', 400);

  // Get the rectangles inside of it

  var colorScale = d3.scaleOrdinal().range(['#e31a1c', '#fd8d3c', '#fecc5c', '#ffffb2']);

  svg.selectAll('rect').data(countries).attr('height', 50).attr('width', function (d) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","02-chart.js"], null)
//# sourceMappingURL=/02-chart.e6e15b46.map