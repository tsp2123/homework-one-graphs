...
},{}],"13-chart.js":[function(require,module,exports) {
'use strict';
...
(function () {
  ...
  var svg = d3.select('#chart13').append('svg').attr('width', width + margin.left + margin.right).attr('height', height + margin.top + margin.bottom).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');

  // Build your scales here
  var widthScale = d3.scaleLinear().domain([0, 10]).range([0, width]);
  ...
  function ready(datapoints) {
    ...
    svg.selectAll('rect').data(datapoints).enter().append('rect').attr('x', 0).attr('y', function (d) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","13-chart.js"], null)
//# sourceMappingURL=/13-chart.1c0236b3.map